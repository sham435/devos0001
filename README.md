...
| --- | --- | --- | --- |
| [my-fastapi-app](projects/active/my-fastapi-app) | Task 3: Security — JWT, password hashing, dependencies | Write JWT create/decode, bcrypt password hashing, get_db/get_current_user depend | 2026-05-23 |
<!-- PROJECTS_END -->
